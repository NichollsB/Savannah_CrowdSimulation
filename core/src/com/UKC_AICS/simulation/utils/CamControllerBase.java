...
public class CamControllerBase extends GestureDetector {
    ...
    protected static class CameraGestureListener extends GestureAdapter {
        public CamControllerBase controller;
    ...
    protected CamControllerBase (final CameraGestureListener gestureListener, final Camera camera) {
    ...
    public CamControllerBase (final Camera camera) {
...
//		} else
    ...
    public boolean superTouchDragged(int screenX, int screenY, int pointer) {
