...
public class Collision extends Behaviour {
    ...
    /**
     * Finds the first cell along the boid trajectory with blocked terrain
     * @param x0 x position of boid
     * @param y0 y position of boid
     * @param dx_dt x component of boid velocity
     * @param dy_dt y component of boid velocity
     * @return information if block cell is encountered. ArrayList - x coord, y coords and number of steps ahead of
     * boids velocity.
     */
    ...
    /**
     * Check to make sure there is no blocked terrain between boid and target location
     * @param boid boid making the check
     * @param targetLocation target location that check is being made to
     * @return boolean of whether view is blocked(true) or not(false).
     */
